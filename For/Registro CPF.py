...
Identificar quantas pessoas o hóspede que acabou de chegar vai ter no quarto (perguntando atraves de input)
...
quantidadePessoas = int(input('Quantas pessoas ficarão no quarto?' ))
quarto = []
